...
public class Version1 extends Resource{
	

	public static int minNbReader;//for objective 2
	public static int minNbWriter;//ident
	
	
	public Version1(IDetector detector, IObservator observator) {
